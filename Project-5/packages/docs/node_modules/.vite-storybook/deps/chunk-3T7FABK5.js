...
} from "./chunk-B4GUB4EM.js";
import {
  require_es_array_iterator,
  require_es_string_iterator
} from "./chunk-QNM2QVAV.js";
import {
  require_window
...
var AbortController = import_global2.default.AbortController;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 9:
                ...
                break;
              case 12:
                import_global2.default.window.location.reload();
                _context12.next = 15;
...
var fetch = import_global3.default.fetch;
...
var Preview = function() {
  function Preview2() {
    ...
    if ((_global$FEATURES = import_global3.default.FEATURES) !== null && _global$FEATURES !== void 0 && _global$FEATURES.storyStoreV7 && addons.hasServerChannel()) {
  ...
  _createClass2(Preview2, [{
    ...
    value: function initializeWithProjectAnnotations(projectAnnotations) {
      ...
      if ((_global$FEATURES2 = import_global3.default.FEATURES) !== null && _global$FEATURES2 !== void 0 && _global$FEATURES2.storyStoreV7) {
    ...
    value: function initializeWithStoryIndex(storyIndex) {
      ...
      return this.storyStore.initialize({
        ...
        cache: !((_global$FEATURES3 = import_global3.default.FEATURES) !== null && _global$FEATURES3 !== void 0 && _global$FEATURES3.storyStoreV7)
      });
    }
  }, {
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 4:
                if (!((_global$FEATURES4 = import_global3.default.FEATURES) !== null && _global$FEATURES4 !== void 0 && _global$FEATURES4.storyStoreV7)) {
                  _context13.next = 7;
                  break;
                }
                _context13.next = 7;
...
var history = import_global4.default.history;
...
var document2 = import_global5.default.document;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.next = 4;
                return import("./renderDocs-VVWQ4OYW.js");
              case 4:
      ...
      var _rerender = _asyncToGenerator3(regeneratorRuntime.mark(function _callee3(isGlobals) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!(!((_global$FEATURES2 = import_global6.default.FEATURES) !== null && _global$FEATURES2 !== void 0 && _global$FEATURES2.modernInlineRender) || isGlobals)) {
                  _context3.next = 3;
                  break;
                }
                _context3.next = 3;
...
var globalWindow = import_global7.default.window;
  ...
  _createClass6(PreviewWeb2, [{
    ...
    value: function initializeWithStoryIndex(storyIndex) {
      ...
      return _get(_getPrototypeOf(PreviewWeb2.prototype), "initializeWithStoryIndex", this).call(this, storyIndex).then(function() {
        var _global$FEATURES;
        if (!((_global$FEATURES = import_global7.default.FEATURES) !== null && _global$FEATURES !== void 0 && _global$FEATURES.storyStoreV7)) {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 39:
                ...
                if ((_global$FEATURES3 = import_global7.default.FEATURES) !== null && _global$FEATURES3 !== void 0 && _global$FEATURES3.storyStoreV7) {
...
var document3 = import_global8.default.document;
var runScriptTypes = [
...
//# sourceMappingURL=chunk-3T7FABK5.js.map
